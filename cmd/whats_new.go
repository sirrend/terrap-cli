...
func init() {
	...
	whatsNewCmd.Flags().StringSliceP("fixed-providers", "f", []string{}, "A comma separated list of fixed providers written in the following format: `<provider>:<version>`.If this flag is used, all other in-context providers are ignored.")
